...
export interface Exam { id: number; subject: string; exam_date: string; scope_start: number; scope_end: number; scope_unit: string; target_passes: number; current_passes: number; forecast_passes: number; plan_version: number; ai_summary: string; tasks: StudyTask[] }
